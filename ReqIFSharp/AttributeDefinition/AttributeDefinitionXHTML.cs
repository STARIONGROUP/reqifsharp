    ...
    public class AttributeDefinitionXHTML : AttributeDefinition
    {
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.MoveToContent() == XmlNodeType.Element && reader.LocalName == "DATATYPE-DEFINITION-XHTML-REF")
                {
                ...
                if (reader.MoveToContent() == XmlNodeType.Element && reader.LocalName == "ATTRIBUTE-VALUE-XHTML")
                {
        ...
        public override void WriteXml(XmlWriter writer)
        {
            if (this.Type == null)
            {
                throw new SerializationException(string.Format("The Type property of AttributeDefinitionXHTML {0}:{1} may not be null", this.Identifier, this.LongName));
            }
