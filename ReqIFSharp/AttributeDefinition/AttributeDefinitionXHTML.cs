...
namespace ReqIFSharp
{
    ...
    public class AttributeDefinitionXHTML : AttributeDefinition
    {
        ...
        /// </param>
        public AttributeDefinitionXHTML(ILoggerFactory loggerFactory) : base(loggerFactory)
        {
        ...
        protected override void SetDatatypeDefinition(DatatypeDefinition datatypeDefinition)
        {
            ...
            {
                throw new ArgumentException($"{nameof(datatypeDefinition)} must of type DatatypeDefinitionXHTML");
            }
