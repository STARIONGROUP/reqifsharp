// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeDefinitionBoolean.cs" company="Starion Group S.A.">
//
...
namespace ReqIFSharp
{
    ...
    public class AttributeDefinitionBoolean : AttributeDefinitionSimple
    {
        ...
        /// </summary>
        private readonly ILogger<AttributeDefinitionBoolean> logger;
        ...
        {
            this.logger = NullLogger<AttributeDefinitionBoolean>.Instance;
        }
        ...
        /// </param>
        public AttributeDefinitionBoolean(ILoggerFactory loggerFactory) : base(loggerFactory)
        {
            this.logger = this.loggerFactory == null ? NullLogger<AttributeDefinitionBoolean>.Instance : this.loggerFactory.CreateLogger<AttributeDefinitionBoolean>();
        }
        ...
        protected override void SetDatatypeDefinition(DatatypeDefinition datatypeDefinition)
        {
            ...
            {
                throw new ArgumentException($"{nameof(datatypeDefinition)} must of type DatatypeDefinitionBoolean");
            }
        ...
        /// <summary>
        /// Asynchronously converts a <see cref="AttributeDefinitionBoolean"/> object into its XML representation.
        /// </summary>
        /// <param name="writer">
        /// an instance of <see cref="XmlWriter"/>
        /// </param>
        ...
        internal override async Task WriteXmlAsync(XmlWriter writer, CancellationToken token)
        {
            ...
            if (this.DefaultValue != null)
            {
                ...
                await writer.WriteAttributeStringAsync(null, "THE-VALUE", null, this.DefaultValue.TheValue ? "true" : "false");
                await writer.WriteStartElementAsync(null, "DEFINITION", null);
                await writer.WriteElementStringAsync(null, "ATTRIBUTE-DEFINITION-BOOLEAN-REF", null, this.DefaultValue.Definition.Identifier);
            ...
            await writer.WriteElementStringAsync(null, "DATATYPE-DEFINITION-BOOLEAN-REF", null, this.Type.Identifier);
            await writer.WriteEndElementAsync();
        }
    }
}
