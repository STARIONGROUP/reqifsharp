// -------------------------------------------------------------------------------------------------
// <copyright file="AttributeDefinitionString.cs" company="Starion Group S.A.">
//
...
namespace ReqIFSharp
{
    ...
    public class AttributeDefinitionString : AttributeDefinitionSimple
    {
        ...
        protected override void SetDatatypeDefinition(DatatypeDefinition datatypeDefinition)
        {
            ...
            {
                throw new ArgumentException($"{nameof(datatypeDefinition)} must of type DatatypeDefinitionString");
            }
