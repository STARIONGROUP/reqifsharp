    ...
    public class AttributeDefinitionString : AttributeDefinitionSimple
    {
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.ReadToDescendant("DATATYPE-DEFINITION-STRING-REF"))
                {
        ...
        public override void WriteXml(XmlWriter writer)
        {
            if (this.Type == null)
            {
                throw new SerializationException(string.Format("The Type property of AttributeDefinitionString {0}:{1} may not be null", this.Identifier, this.LongName));
            }
