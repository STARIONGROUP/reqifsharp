// -------------------------------------------------------------------------------------------------
// <copyright file="DatatypeDefinitionDate.cs" company="Starion Group S.A.">
//
...
namespace ReqIFSharp
{
    ...
    public class DatatypeDefinitionDate : DatatypeDefinitionSimple
    {
        ...
        /// </param>
        public DatatypeDefinitionDate(ILoggerFactory loggerFactory)
            : base(loggerFactory)
        {
        }
        ...
        /// The (injected) <see cref="ILoggerFactory"/> used to set up logging
        /// </param>
        internal DatatypeDefinitionDate(ReqIFContent reqIfContent, ILoggerFactory loggerFactory)
