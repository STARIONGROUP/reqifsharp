...
namespace ReqIFSharp
{
    ...
    public class AttributeValueReal : AttributeValueSimple
    {
        ...
        public override void ReadXml(XmlReader reader)
        {
            ...
            while (reader.Read())
            {
                if (reader.ReadToDescendant("ATTRIBUTE-DEFINITION-REAL-REF"))
                {
                    ...
                    AttributeDefinitionReal attributeDefinitionReal = null;
                    foreach (var specType in this.SpecElAt.ReqIfContent.SpecTypes)
                    {
                        foreach (var attributeDefinition in specType.SpecAttributes)
                        {
                            ...
                            {
                                attributeDefinitionReal = (AttributeDefinitionReal)attributeDefinition;
                                break;
                            }
                        }
                    }

                    this.Definition = attributeDefinitionReal;
        ...
        public override void WriteXml(XmlWriter writer)
        {
            ...
            {
                throw new SerializationException(string.Format("The Definition property of an AttributeValueReal may not be null"));
            }
